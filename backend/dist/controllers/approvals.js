...
exports.deleteMatrixRule = exports.updateMatrixRule = exports.createMatrixRule = exports.getMatrixRules = exports.bulkActionApproval = exports.actionApproval = exports.getPendingApprovals = void 0;
...
const parseSAPWorktime = (dateField, timeStr) => {
...
const getPendingApprovals = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const response = yield (0, s4hana_1.s4hanaRequest)('GET', `/sap/opu/odata/sap/Z_INOXGFL_SRV_SRV/PendingApprovalsSet?$filter=${getEmailFilter(userEmail)}`, undefined, undefined, jwtToken);
        let rawSteps = ((_c = response.d) === null || _c === void 0 ? void 0 : _c.results) || response.d || [];
        ...
        stepsArray = stepsArray.filter((step) => (step.ApprovalEmail || step.ApproverEmail || '').toLowerCase() === userEmail.toLowerCase());
        // Map OData fields to structure expected by frontend ApprovalDashboard.tsx
        const mappedApprovals = stepsArray.map((step) => {
...
const actionApproval = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const response = yield (0, s4hana_1.s4hanaRequest)('POST', '/sap/opu/odata/sap/Z_INOXGFL_SRV_SRV/ApprovalActionSet', payload, undefined, jwtToken);
...
const bulkActionApproval = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        for (const stepId of stepIds) {
            ...
            yield (0, s4hana_1.s4hanaRequest)('POST', '/sap/opu/odata/sap/Z_INOXGFL_SRV_SRV/ApprovalActionSet', payload, undefined, jwtToken);
        }
...
const getMatrixRules = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const jwtToken = (_a = req.headers.authorization) === null || _a === void 0 ? void 0 : _a.split(' ')[1];
        const response = yield (0, s4hana_1.s4hanaRequest)('GET', '/sap/opu/odata/sap/Z_INOXGFL_SRV_SRV/ApprovalMatrixSet', undefined, undefined, jwtToken);
        const rawRules = ((_b = response.d) === null || _b === void 0 ? void 0 : _b.results) || response.d || [];
...
const createMatrixRule = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const response = yield (0, s4hana_1.s4hanaRequest)('POST', '/sap/opu/odata/sap/Z_INOXGFL_SRV_SRV/ApprovalMatrixSet', payload, undefined, jwtToken);
...
const updateMatrixRule = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        yield (0, s4hana_1.s4hanaRequest)('PUT', `/sap/opu/odata/sap/Z_INOXGFL_SRV_SRV/ApprovalMatrixSet('${id}')`, payload, undefined, jwtToken);
...
const deleteMatrixRule = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        yield (0, s4hana_1.s4hanaRequest)('DELETE', `/sap/opu/odata/sap/Z_INOXGFL_SRV_SRV/ApprovalMatrixSet('${id}')`, undefined, undefined, jwtToken);
